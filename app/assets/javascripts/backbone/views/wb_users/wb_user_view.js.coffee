...
class WbAnalyst.Views.WbUsers.WbUserView extends Backbone.View
  ...
  isHidden: () ->
    ...
    ( not (verified_type is 0) && (WbAnalyst.WbUserFilter is "verified")) || ( not (verified_type is 220) && (WbAnalyst.WbUserFilter is "starred")) || ( not (verified_type is -1) && (WbAnalyst.WbUserFilter is "unverified"))
